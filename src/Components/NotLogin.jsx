  ...
  return (
    <div className="w-full h-screen flex relative">
      <div
        ...
        style={{
          backgroundImage:
            "url('https://marketplace.canva.com/EAEv8Ro3O0o/1/0/1600w/canva-ye%C5%9Fil-tipografik-ev-yemekleri-lokantas%C4%B1-logosu-logo-DIjEwIAhYd8.jpg')",
        }}
      ></div>
      <div className="w-1/2 flex items-center justify-center bg-gray-50">
        <div className="w-3/5">
          <h2 className="text-5xl font-bold text-gray-800 mb-8">
            Nerde Ne Yenir Merak Ediyor musun?
          </h2>
          ...
          {/* Kaydol Butonu */}
          <button
            className="w-full bg-blue-500 text-white p-2 rounded-lg text-lg font-semibold hover:bg-blue-600 transition duration-300"
          ...
          <div className="bg-white p-8 rounded-lg w-1/3 relative">
            ...
            {!isCodeSent ? (
              ...
              <>
                ...
                <p className="text-gray-600 mb-5 text-center">
                  E-posta adresinize gönderilen doğrulama kodunu girin ve yeni
                  şifrenizi oluşturun.
                </p>
      ...
      {isSignupOpen && (
        <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center">
          <div className="bg-white p-8 rounded-lg w-1/3 h-4/5 relative shadow-lg">
            {/* Modal Kapatma Düğmesi */}
            <button
              className="absolute top-2 right-2 text-gray-500 hover:text-gray-700"
            ...
            <h3 className="text-2xl font-semibold mb-6 text-center text-gray-800">
              Aramıza katıldığın için heyecanlıyız!
            </h3>
